...
public class p1 {
	...
	public static String inPathString="/home/Lee/data/123";
	public static String outPathString="/home/Lee/data/result";
...
class MyThread extends Thread{
	...
	public void run(){
		...
		System.out.println("@allprocess.MyThread.run() - 初始化工作两步骤都完成");
	...
	//	System.out.println("!!!!" + csk.allDocs.size() +"\t" + (csk.allDocs.get(100)==null));
		...
		System.out.println("@allprocess.MyThread.run() - 计算相似读完成");
		write(csk.SIMap);
		p1.sTACK.pop();
	}
